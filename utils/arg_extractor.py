...
def get_args():
    ...
    parser.add_argument('--num_epochs', default=200, type=int, help="num of ephochs for training (int): default 200 ")
    parser.add_argument("--lr", default=0.0002, type=float, help="learning rate (float): 0.0002")
    parser.add_argument("--l1_coef", default=5, type=float, help="l1 coefficient for discriminator loss")
    parser.add_argument("--l2_coef", default=10, type=float, help="l2 coefficient for discriminator loss")
    ...
    parser.add_argument('--filepath_to_config_file', default=None, help='file path to arguments json file')
