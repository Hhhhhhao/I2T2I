...
class BaseTrainer:
    ...
    def __init__(self, rnn_encoder, cnn_encoder, loss, optimizer, config, train_logger=None):
        self.config = config
        ...
        self.results_dir = os.path.join(self.checkpoint_dir, 'results')
    ...
    def _save_checkpoint(self, epoch, save_best=False):
        ...
        """
        rnn_arch = type(self.rnn_encoder).__name__
        cnn_arch = type(self.cnn_encoder).__name__
        state = {
            'rnn_arch': rnn_arch,
            'cnn_arch': cnn_arch,
            'epoch': epoch,
