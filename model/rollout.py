...
class Rollout:
    ...
    def __init__(self, max_sentence_length, embedding_layer):
        self.embedding_layer = embedding_layer
        self.lstm = None
        self.max_sentence_length = max_sentence_length
        self.output_linear = None

    def reward(self, generated, image_features, states, monte_carlo_count, evaluator, steps=1):
        ...
        with torch.no_grad():
            ...
            for _ in range(steps):
                ...
                reward = evaluator.forward_given_image_features(image_features.repeat(monte_carlo_count, 1), current_generated)
