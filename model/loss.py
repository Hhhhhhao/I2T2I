...
def words_loss(img_features, words_emb, labels,
               cap_lens, class_ids, batch_size, opt):
    """
    ...
    for i in range(batch_size):
        ...
        """
        weiContext, attn = func_attention(word, context, opt.gamma1)
    ...
    similarities = similarities * opt.gamma3
    if class_ids is not None:
...
def attangan_discriminator_loss(netD, real_imgs, fake_imgs, conditions,
...
def attangan_generator_loss(netsD, image_encoder, fake_imgs, real_labels,
